...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  - What I pay attention is how easy it is to read and understand, does it have 
  lots of docstring and notes, is there a way to complete the task in a more simple manner? The small details in code can be very useful when trying to interprete and understand someone else's code and it makes it easier on the eyes to follow. Lots of documentaion where needed.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situations

  - We could have containers that have the same environment and dependencies so that even if people have different computer they will be able to basically share the same virtual environment so that it is easier and more straight forward when writing code, testing, and deploying in teams. Containers are small and are easily shared with peers and it removes the factors of people having different machines with different things running on each of the machines that can cause headaches and time and resources to be wasted when it could be used productively with a stable environment to work on.
